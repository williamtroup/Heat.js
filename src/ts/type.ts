...
export type BindingOptionsEvents = {
    ...
    onMapDayClick?: ( element: HTMLElement, date: Date, count: number, isHoliday: boolean ) => void;
    onMapDayDblClick?: ( element: HTMLElement, date: Date, count: number, isHoliday: boolean ) => void;
    onLineDayClick?: ( element: HTMLElement, date: Date, count: number, isHoliday: boolean ) => void;
    onLineDayDblClick?: ( element: HTMLElement, date: Date, count: number, isHoliday: boolean ) => void;
    onChartDayClick?: ( element: HTMLElement, date: Date, count: number, isHoliday: boolean ) => void;
    onChartDayDblClick?: ( element: HTMLElement, date: Date, count: number, isHoliday: boolean ) => void;
