...
export type BindingOptionsView = {
    enabled?: boolean;
    monthsToShow?: number[];
    daysToShow?: number[];
};

export type BindingOptionsViewsMap = BindingOptionsView & {
...
export type BindingOptionsViewsChart = BindingOptionsView & {
...
export type BindingOptionsEvents = {
    ...
    onAddDate?: ( element: HTMLElement, date: Date ) => void;
    onRemoveDate?: ( element: HTMLElement, date: Date ) => void;
    onClearDate?: ( element: HTMLElement, date: Date ) => void;
    onUpdateDate?: ( element: HTMLElement, date: Date ) => void;
    ...
    onMapDayToolTipRender?: ( element: HTMLElement, date: Date, count: number, year: number, isHoliday: boolean ) => void;
    ...
    onLineDayToolTipRender?: ( element: HTMLElement, date: Date, count: number, year: number, isHoliday: boolean ) => void;
    ...
    onChartDayToolTipRender?: ( element: HTMLElement, date: Date, count: number, year: number, isHoliday: boolean ) => void;
    ...
    onColorRangeClick?: ( element: HTMLElement, colorRange: BindingOptionsColorRange, count: number, year: number ) => void;
    onColorRangeDblClick?: ( element: HTMLElement, colorRange: BindingOptionsColorRange, count: number, year: number ) => void;
