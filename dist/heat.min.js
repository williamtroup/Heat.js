...
k[a].options;c.element.innerHTML=q.empty;c.element.className=q.empty;u(c.onDestroy,c.element);delete k[a]}return this};this.setConfiguration=function(a){f=J(a)?a:{};W();return this};this.getVersion=function(){return"1.1.0"};(function(a,c){A=a;L=c;W();A.addEventListener("DOMContentLoaded",function(){for(var b=f.domElementTypes,e=b.length,g=0;g<e;g++){var h=A.getElementsByTagName(b[g]);h=[].slice.call(h);for(var l=h.length,p=0;p<l;p++){var m=h[p],E=!0;if(w(m)&&m.hasAttribute("data-heat-options")){var d=
