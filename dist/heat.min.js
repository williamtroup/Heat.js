...
D){return D.range-z.range}),e=ja(a),g=a.currentView.mapContents.offsetHeight/e,k=a.currentView.year,m=0;0<e&&(u(b,"div","label-top",e.toString()),u(b,"div","label-middle",Math.floor(e/2).toString()),u(b,"div","label-bottom","0"));for(b=0;12>b;b++)if(-1<a.monthsToShow.indexOf(b+1)){e=N(k,b);for(var l=1,r=0;r<e;r++)-1<a.daysToShow.indexOf(l)&&ra(c,a,r+1,b,k,d,g),0===(r+1)%7&&(l=0),l++,m++}a.keepScrollPositions&&(a.currentView.chartContents.scrollLeft=a.currentView.chartContentsScrollLeft)}function ra(a,
c,b,d,e,g,k){var m=new Date(e,d,b);b=n(a,"div","day-line");var l=h[c.currentView.element.id].type[c.currentView.type][F(m)];l=H(l)?l:0;E(c.onDayToolTipRender)?b.title=q(c.onDayToolTipRender,m,l):b.title=ca(c.dayToolTipText,m);b.style.height=l*k+"px";b.offsetHeight>a.offsetHeight/2&&(b.style.height=b.offsetHeight-5+"px");E(c.onDayClick)?b.onclick=function(){q(c.onDayClick,m,l)}:b.className+=p.space+"no-click";a=c.mapRangeColors.length;k=null;for(d=0;d<a;d++)if(e=g[d],l>=e.minimum)k=e;else break;v(k)&&
R(c,k.id)&&(b.className+=p.space+k.cssClassName)}function la(a){var c=n(a.currentView.element,"div","guide"),b=n(c,"div","map-types"),d=0;for(g in h[a.currentView.element.id].type.None)if(h[a.currentView.element.id].type.None.hasOwnProperty(g)){d++;break}if(1<h[a.currentView.element.id].types)for(var e in h[a.currentView.element.id].type)if("None"!==e||0<d)0===d&&"None"===a.currentView.type&&(a.currentView.type=e),sa(a,b,e);if(a.showGuide){c=n(c,"div","map-toggles");b=u(c,"div","less-text",f.lessText);
a.mapTogglesEnabled?b.onclick=function(){Z(a,!1)}:b.className+=p.space+"no-click";b=n(c,"div","days");d=a.mapRangeColors.sort(function(k,m){return m.range-k.range});var g=d.length;for(e=0;e<g;e++)ta(a,b,d[e]);c=u(c,"div","more-text",f.moreText);a.mapTogglesEnabled?c.onclick=function(){Z(a,!0)}:c.className+=p.space+"no-click"}}function sa(a,c,b){c=u(c,"button","type",b);a.currentView.type===b&&(c.className+=p.space+"active");c.onclick=function(){a.currentView.type!==b&&(a.currentView.type=b,q(a.onTypeSwitch,
b),t(a))}}function ta(a,c,b){var d=n(c,"div");d.title=b.tooltipText;R(a,b.id)?d.className="day "+b.cssClassName:d.className="day";a.mapTogglesEnabled?d.onclick=function(){a.currentView.colorsVisible.hasOwnProperty(b.id)||(a.currentView.colorsVisible[b.id]=!0);d.className=a.currentView.colorsVisible[b.id]?"day":"day "+b.cssClassName;a.currentView.colorsVisible[b.id]=!a.currentView.colorsVisible[b.id];t(a)}:d.className+=p.space+"no-click"}function G(a){a=a.toString().replace(/(\r\n|\n|\r)/gm,p.empty).replace(/(\s\s)/gm,
p.space);a=a.replace(/"/g,'""');return'"'+a+'"'}function N(a,c){return(new Date(a,c+1,0)).getDate()}function aa(a){return 0>a.getDay()-1?6:a.getDay()-1}function ca(a,c){var b=a,d=aa(c);b=b.replace("{dddd}",f.dayNames[d]);b=b.replace("{dd}",C(c.getDate()));b=b.replace("{d}",c.getDate());d=b.replace;var e=c.getDate(),g=f.thText;if(31===e||21===e||1===e)g=f.stText;else if(22===e||2===e)g=f.ndText;else if(23===e||3===e)g=f.rdText;b=d.call(b,"{o}",g);b=b.replace("{mmmm}",f.monthNames[c.getMonth()]);b=
b.replace("{mm}",C(c.getMonth()+1));b=b.replace("{m}",c.getMonth()+1);b=b.replace("{yyyy}",c.getFullYear());b=b.replace("{yyy}",c.getFullYear().toString().substring(1));b=b.replace("{yy}",c.getFullYear().toString().substring(2));return b=b.replace("{y}",parseInt(c.getFullYear().toString().substring(2)).toString())}function v(a){return null!==a&&void 0!==a&&a!==p.empty}function L(a){return v(a)&&"object"===typeof a}function O(a){return v(a)&&"boolean"===typeof a}function B(a){return v(a)&&"string"===
typeof a}function E(a){return v(a)&&"function"===typeof a}function H(a){return v(a)&&"number"===typeof a}function Q(a){return L(a)&&a instanceof Array}function n(a,c,b){c=c.toLowerCase();var d="text"===c;T.hasOwnProperty(c)||(T[c]=d?A.createTextNode(p.empty):A.createElement(c));c=T[c].cloneNode(!1);v(b)&&(c.className=b);a.appendChild(c);return c}function u(a,c,b,d){a=n(a,c,b);a.innerHTML=d;return a}function ba(a,c,b){var d=null;b=v(b)?b:!1;P.getComputedStyle?d=A.defaultView.getComputedStyle(a,null).getPropertyValue(c):
a.currentStyle&&(d=a.currentStyle[c]);b&&(d=parseFloat(d,10));return d}function q(a){var c=null;E(a)&&(c=a.apply(null,[].slice.call(arguments,1)));return c}function w(a,c){return B(a)?a:c}function x(a,c){return O(a)?a:c}function y(a,c){return E(a)?a:c}function ea(a){var c=!0,b=null;try{B(a)&&(b=JSON.parse(a))}catch(d){try{b=eval("("+a+")"),E(b)&&(b=b())}catch(e){f.safeMode||(console.error("Errors in object: "+d.message+", "+e.message),c=!1),b=null}}return{parsed:c,result:b}}function X(){for(var a=
[],c=0;32>c;c++){8!==c&&12!==c&&16!==c&&20!==c||a.push("-");var b=Math.floor(16*Math.random()).toString(16);a.push(b)}return a.join(p.empty)}function C(a){a=a.toString();return 1===a.length?"0"+a:a}function F(a){return a.getFullYear()+"-"+C(a.getMonth()+1)+"-"+C(a.getDate())}function da(){f.safeMode=x(f.safeMode,!0);var a=f,c=f.domElementTypes,b=["*"];B(c)?(c=c.split(p.space),0===c.length&&(c=b)):c=Q(c)?c:b;a.domElementTypes=c;f.stText=w(f.stText,"st");f.ndText=w(f.ndText,"nd");f.rdText=w(f.rdText,
"rd");f.thText=w(f.thText,"th");f.backButtonText=w(f.backButtonText,"Back");f.nextButtonText=w(f.nextButtonText,"Next");f.refreshButtonText=w(f.refreshButtonText,"Refresh");f.exportButtonText=w(f.exportButtonText,"Export");f.lessText=w(f.lessText,"Less");f.moreText=w(f.moreText,"More");f.dateText=w(f.dateText,"Date");f.countText=w(f.countText,"Count");f.mapText=w(f.mapText,"Map");f.chartText=w(f.chartText,"Chart");M(f.monthNames,12)&&(f.monthNames="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "));
M(f.dayNames,7)&&(f.dayNames="Mon Tue Wed Thu Fri Sat Sun".split(" "))}function M(a,c){c=H(c)?c:1;return!Q(a)||a.length<c}var A=null,P=null,f={},p={empty:"",space:" ",newLine:"\n"},T={},K=null,h={};this.addDate=function(a,c,b,d){h.hasOwnProperty(a)&&(d=O(d)?d:!0,b=B(b)?b:"None",c=F(c),h[a].type.hasOwnProperty(b)||(h[a].type[b]={},h[a].types++),h[a].type[b].hasOwnProperty(c)||(h[a].type[b][c]=0),h[a].type[b][c]++,b=h[a].options,q(b.onAdd,b.currentView.element),d&&t(h[a].options));return this};this.removeDate=
function(a,c,b,d){h.hasOwnProperty(a)&&(b=B(b)?b:"None",c=F(c),h[a].type.hasOwnProperty(b)&&h[a].type[b].hasOwnProperty(c)&&(d=O(d)?d:!0,0<h[a].type[b][c]&&h[a].type[b][c]--,b=h[a].options,q(b.onRemove,b.currentView.element),d&&t(h[a].options)));return this};this.reset=function(a,c){if(h.hasOwnProperty(a)){c=O(c)?c:!0;var b=h[a].options;b.currentView.type="None";Y(a,b);q(b.onReset,b.currentView.element);c&&t(h[a].options)}return this};this.refresh=function(a){h.hasOwnProperty(a)&&(a=h[a].options,
...
return c};this.render=function(a,c){V(W(c,a));return this};this.renderAll=function(){U();return this};this.destroyAll=function(){for(var a in h)if(h.hasOwnProperty(a)){var c=h[a].options;c.currentView.element.innerHTML=p.empty;c.currentView.element.className=p.empty;q(c.onDestroy,c.currentView.element)}h={};return this};this.destroy=function(a){if(h.hasOwnProperty(a)){var c=h[a].options;c.currentView.element.innerHTML=p.empty;c.currentView.element.className=p.empty;q(c.onDestroy,c.currentView.element);
delete h[a]}return this};this.setConfiguration=function(a){f=L(a)?a:{};da();return this};this.getVersion=function(){return"1.5.0"};(function(a,c){A=a;P=c;da();A.addEventListener("DOMContentLoaded",function(){U()});v(P.$heat)||(P.$heat=this)})(document,window)})();