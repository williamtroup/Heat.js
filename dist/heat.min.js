...
a.currentView.year);m(a.currentView.yearText,"div","down-arrow");if(a.showYearSelectionDropDown){b=m(a.currentView.yearText,"div","years-list");d=m(b,"div","years");var e=(new Date).getFullYear(),f=null;b.style.display="block";b.style.visibility="hidden";for(var g=e-a.extraSelectionYears;g<e+a.extraSelectionYears;g++){var l=Ea(a,d,g);t(f)||(f=l)}t(f)&&(d.scrollTop=f.offsetTop-d.offsetHeight/2);b.style.display="none";b.style.visibility="visible"}q(c,"button","next",h.nextButtonText).onclick=function(){a.currentView.year++;
u(a);p(a.onNextYear,a.currentView.year)}}}}function ia(a,c,b,d){a.currentView.view===b?H(c,"title-active"):c.onclick=function(){a.currentView.view=b;p(a.onViewSwitch,d);u(a)}}function Ea(a,c,b){var d=null;c=q(c,"div","year",b);a.currentView.year!==b?c.onclick=function(){a.currentView.year=b;u(a);p(a.onNextYear,a.currentView.year)}:(H(c,"year-active"),d=c);return d}function za(a,c,b,d,e,f){b+=1;c=m(c,"div","day");var g=new Date(e,d,b),l=k[a.currentView.element.id].type[a.currentView.type][N(g)];l=
T(l)?l:0;O(a.onDayToolTipRender)?Q(c,a,p(a.onDayToolTipRender,g,l)):Q(c,a,sa(a.dayToolTipText,g));a.views.map.showDayNumbers&&0<l&&(c.innerHTML=l.toString());O(a.onDayClick)?c.onclick=function(){p(a.onDayClick,g,l)}:H(c,"no-hover");d=fa(f,l);t(d)&&Y(a,d.id)&&H(c,d.cssClassName);return c}function Ba(a,c,b,d,e,f,g){var l=new Date(e,d,b);a=m(a,"div","day-line");var n=P(c)[N(l)];n=T(n)?n:0;O(c.onDayToolTipRender)?Q(a,c,p(c.onDayToolTipRender,l,n)):Q(a,c,sa(c.dayToolTipText,l));a.style.height=n*g+"px";
a.style.setProperty("border-bottom-width","0","important");O(c.onDayClick)?a.onclick=function(){p(c.onDayClick,l,n)}:H(a,"no-hover");f=fa(f,n);t(f)&&Y(c,f.id)&&H(a,f.cssClassName)}function ya(a){var c=m(a.currentView.element,"div","guide"),b=m(c,"div","map-types"),d=0;for(f in k[a.currentView.element.id].type.None)if(k[a.currentView.element.id].type.None.hasOwnProperty(f)){d++;break}if(1<k[a.currentView.element.id].types)for(var e in k[a.currentView.element.id].type){if("None"!==e||0<d)0===d&&"None"===
a.currentView.type&&(a.currentView.type=e),Fa(a,b,e)}else F(a.noTypesLabel)&&(F(a.noTypesLabelLink)?q(b,"a","label",a.noTypesLabel).href=a.noTypesLabelLink:q(b,"span","label",a.noTypesLabel));if(a.showGuide){c=m(c,"div","map-toggles");b=q(c,"div","less-text",h.lessText);a.mapTogglesEnabled?b.onclick=function(){ta(a,!1)}:H(b,"no-click");b=m(c,"div","days");d=U(a);var f=d.length;for(e=0;e<f;e++)Ga(a,b,d[e]);c=q(c,"div","more-text",h.moreText);a.mapTogglesEnabled?c.onclick=function(){ta(a,!0)}:H(c,"no-click")}}
function Fa(a,c,b){c=q(c,"button","type",b);a.currentView.type===b&&H(c,"active");c.onclick=function(){a.currentView.type!==b&&(a.currentView.type=b,p(a.onTypeSwitch,b),u(a))}}function Ga(a,c,b){c=m(c,"div");Q(c,a,b.tooltipText);Y(a,b.id)?c.className="day "+b.cssClassName:c.className="day";a.mapTogglesEnabled?c.onclick=function(){for(var d=b.id,e=a.colorRanges.length,f=0;f<e;f++){var g=a.colorRanges[f];if(g.id===d){g.visible=!(L(g.visible)&&g.visible);p(a.onColorRangeTypeToggle,g.id,g.visible);u(a);
break}}}:H(c,"no-hover")}function Y(a,c){for(var b=!1,d=a.colorRanges.length,e=0;e<d;e++){var f=a.colorRanges[e];if(f.id===c&&(!L(f.visible)||f.visible)){b=!0;break}}return b}function ta(a,c){for(var b=a.colorRanges.length,d=0;d<b;d++)a.colorRanges[d].visible=c,p(a.onColorRangeTypeToggle,a.colorRanges[d].id,c);u(a)}function fa(a,c){for(var b=a.length,d=null,e=0;e<b;e++){var f=a[e];if(c>=f.minimum)d=f;else break}return d}function U(a){return a.colorRanges.sort(function(c,b){return c.minimum-b.minimum})}
function ra(a){var c=null;var b=null;"csv"===a.exportType.toLowerCase()?b="text/csv":"json"===a.exportType.toLowerCase()?b="application/json":"xml"===a.exportType.toLowerCase()&&(b="application/xml");if("csv"===a.exportType.toLowerCase()){var d=ja(a);c=[];for(var e in d)d.hasOwnProperty(e)&&c.push([Z(e),Z(d[e])].join());0<c.length&&c.unshift([Z(h.dateText),Z(h.countText)].join());c=c.join(r.newLine)}else if("json"===a.exportType.toLowerCase())c=ka.stringify(ja(a));else if("xml"===a.exportType.toLowerCase()){e=
