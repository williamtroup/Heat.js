...
"div","guide"),c=p(b,"div","map-types"),e=0;for(h in k[a.element.id].type.None)if(k[a.element.id].type.None.hasOwnProperty(h)){e++;break}if(1<k[a.element.id].types)for(var g in k[a.element.id].type)if("None"!==g||0<e)0===e&&"None"===a.currentView.type&&(a.currentView.type=g),ja(a,c,g);if(a.showGuide){b=p(b,"div","map-toggles");c=z(b,"div","less-text",f.lessText);a.mapTogglesEnabled?c.onclick=function(){V(a,!1)}:c.className+=n.space+"no-click";c=p(b,"div","days");e=a.mapRangeColors.sort(function(l,
m){return m.range-l.range});var h=e.length;for(g=0;g<h;g++)ka(a,c,e[g]);b=z(b,"div","more-text",f.moreText);a.mapTogglesEnabled?b.onclick=function(){V(a,!0)}:b.className+=n.space+"no-click"}}function ja(a,b,c){b=z(b,"button","type",c);a.currentView.type===c&&(b.className+=n.space+"active");b.onclick=function(){a.currentView.type!==c&&(a.currentView.type=c,t(a.onTypeSwitch,c),w(a))}}function ka(a,b,c){var e=p(b,"div");e.title=c.tooltipText;U(a,c.id)?e.className="day "+c.cssClassName:e.className="day";
a.mapTogglesEnabled?e.onclick=function(){a.currentView.colorsVisible.hasOwnProperty(c.id)||(a.currentView.colorsVisible[c.id]=!0);e.className=a.currentView.colorsVisible[c.id]?"day":"day "+c.cssClassName;a.currentView.colorsVisible[c.id]=!a.currentView.colorsVisible[c.id];w(a)}:e.className+=n.space+"no-click"}function U(a,b){return!a.currentView.colorsVisible.hasOwnProperty(b)||a.currentView.colorsVisible[b]}function W(a,b){k[a]={options:b,type:{},types:1};k[a].type.None={}}function V(a,b){for(var c=
a.mapRangeColors.length,e=0;e<c;e++)a.currentView.colorsVisible[a.mapRangeColors[e].id]=b;w(a)}function G(a){a=a.toString().replace(/(\r\n|\n|\r)/gm,n.empty).replace(/(\s\s)/gm,n.space);a=a.replace(/"/g,'""');return'"'+a+'"'}function S(a){return 0>a.getDay()-1?6:a.getDay()-1}function ia(a,b){var c=a,e=S(b);c=c.replace("{dddd}",f.dayNames[e]);c=c.replace("{dd}",C(b.getDate()));c=c.replace("{d}",b.getDate());e=c.replace;var g=b.getDate(),h=f.thText;if(31===g||21===g||1===g)h=f.stText;else if(22===g||
2===g)h=f.ndText;else if(23===g||3===g)h=f.rdText;c=e.call(c,"{o}",h);c=c.replace("{mmmm}",f.monthNames[b.getMonth()]);c=c.replace("{mm}",C(b.getMonth()+1));c=c.replace("{m}",b.getMonth()+1);c=c.replace("{yyyy}",b.getFullYear());c=c.replace("{yyy}",b.getFullYear().toString().substring(1));c=c.replace("{yy}",b.getFullYear().toString().substring(2));return c=c.replace("{y}",parseInt(b.getFullYear().toString().substring(2)).toString())}function x(a){return null!==a&&void 0!==a&&a!==n.empty}function L(a){return x(a)&&
"object"===typeof a}function M(a){return x(a)&&"boolean"===typeof a}function D(a){return x(a)&&"string"===typeof a}function J(a){return x(a)&&"function"===typeof a}function P(a){return x(a)&&"number"===typeof a}function Q(a){return L(a)&&a instanceof Array}function p(a,b,c){b=b.toLowerCase();var e="text"===b;R.hasOwnProperty(b)||(R[b]=e?B.createTextNode(n.empty):B.createElement(b));b=R[b].cloneNode(!1);x(c)&&(b.className=c);a.appendChild(b);return b}function z(a,b,c,e){a=p(a,b,c);a.innerHTML=e;return a}
function T(a,b,c){var e=null;c=x(c)?c:!1;N.getComputedStyle?e=B.defaultView.getComputedStyle(a,null).getPropertyValue(b):a.currentStyle&&(e=a.currentStyle[b]);c&&(e=parseFloat(e,10));return e}function t(a){var b=null;J(a)&&(b=a.apply(null,[].slice.call(arguments,1)));return b}function v(a,b){return D(a)?a:b}function y(a,b){return M(a)?a:b}function A(a,b){return J(a)?a:b}function la(a){var b=!0,c=null;try{D(a)&&(c=JSON.parse(a))}catch(e){try{c=eval("("+a+")"),J(c)&&(c=c())}catch(g){f.safeMode||(console.error("Errors in object: "+
