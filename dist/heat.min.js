...
(function(){function sa(){for(var a=g.domElementTypes,b=a.length,c=0;c<b;c++){var d=E.getElementsByTagName(a[c]);d=[].slice.call(d);for(var e=d.length,f=0;f<e;f++){var h=d[f],l=!0;if(q(h)&&h.hasAttribute("data-heat-options")){var m=h.getAttribute("data-heat-options");A(m)?(m=la(m),m.parsed&&K(m.result)?ta(ua(m.result,h)):g.safeMode||(console.error("The attribute 'data-heat-options' is not a valid object."),l=!1)):g.safeMode||(console.error("The attribute 'data-heat-options' has not been set correctly."),
...
B.localStorage){for(var d=B.localStorage.length,e=[],f=0;f<d;f++)xa(B.localStorage.key(f),"HJS_"+b)&&e.push(B.localStorage.key(f));d=e.length;for(f=0;f<d;f++)B.localStorage.removeItem(e[f])}e=ba.stringify(k[b].type);B.localStorage.setItem("HJS_"+b,e)}q(a.currentView.mapContents)&&(a.currentView.mapContentsScrollLeft=a.currentView.mapContents.scrollLeft);a.views.chart.enabled&&q(a.currentView.chartContents)&&(a.currentView.chartContentsScrollLeft=a.currentView.chartContents.scrollLeft);a.views.statistics.enabled&&
q(a.currentView.statisticsContents)&&(a.currentView.statisticsContentsScrollLeft=a.currentView.statisticsContents.scrollLeft);a.currentView.element.innerHTML=p.empty;ca(a);Ga(a);Ha(a);f=c;a.currentView.mapContents=n(a.currentView.element,"div","map-contents");ma(a.currentView.mapContents,a);d=n(a.currentView.mapContents,"div","map");b=a.currentView.year;e=!1;f&&w(d,"view-switch");a.views.chart.enabled&&(a.currentView.chartContents=n(a.currentView.element,"div","chart-contents"),ma(a.currentView.chartContents,
a));a.views.statistics.enabled&&(a.currentView.statisticsContents=n(a.currentView.element,"div","statistics-contents"),ma(a.currentView.statisticsContents,a));Ia(a);if(a.views.map.showDayNames){f=n(d,"div","days");if(!a.views.map.showMonthNames||a.views.map.placeMonthNamesOnTheBottom)f.className="days-months-bottom";for(var h=0;7>h;h++)a.views.map.daysToShow.indexOf(h+1)>G.notFound&&u(f,"div","day-name",g.dayNames[h]);a.views.map.showDaysInReverseOrder&&ya(f)}d=n(d,"div","months");f=da(a);for(h=0;12>
h;h++)if(ea(a.views.map.monthsToShow,h)){var l=n(d,"div","month"),m=n(l,"div","day-columns"),F=X(b,h),C=n(m,"div","day-column"),z=!1;var x=na(new Date(b,h,1));var H=1;F+=x;for(var I=0;I<F;I++){I>=x?z=!0:a.views.map.daysToShow.indexOf(H)>G.notFound&&n(C,"div","day-disabled");if(z){var P=null;a.views.map.daysToShow.indexOf(H)>G.notFound&&(P=Ja(a,C,I-x,h,b,f));if(0===(I+1)%7&&(a.views.map.showDaysInReverseOrder&&ya(C),C=n(m,"div","day-column"),H=0,!q(T)&&q(P))){var Ka=fa(P,"margin-left",!0),La=fa(P,
"margin-right",!0);T=P.offsetWidth+Ka+La}}H++}a.views.map.showMonthNames&&(F=l.offsetWidth,m=a.views.map.placeMonthNamesOnTheBottom?u(l,"div","month-name-bottom",g.monthNames[h]):u(l,"div","month-name",g.monthNames[h],m),q(m)&&(m.style.width=a.views.map.showMonthDayGaps?F+"px":F-T+"px"));e&&q(T)&&(0<x&&!a.views.map.showMonthDayGaps?l.style.marginLeft=-T+"px":0===x&&a.views.map.showMonthDayGaps&&(l.style.marginLeft=T+"px"));e=!0}a.keepScrollPositions&&(a.currentView.mapContents.scrollLeft=a.currentView.mapContentsScrollLeft);
if(a.views.chart.enabled){f=c;l=n(a.currentView.chartContents,"div","chart");x=n(l,"div","y-labels");b=n(l,"div","day-lines");e=da(a);d=0;h=Q(a);for(m=0;12>m;m++)for(F=X(a.currentView.year,m),C=0;C<F;C++)z=R(new Date(a.currentView.year,m,C+1)),h.hasOwnProperty(z)&&(d=J.max(d,parseInt(h[z])));m=d;h=a.currentView.year;d=0;f&&w(l,"view-switch");0<m&&a.views.chart.showChartYLabels?(d=u(x,"div","label-0",m.toString()),u(x,"div","label-25",(3*J.floor(m/4)).toString()),u(x,"div","label-50",J.floor(m/2).toString()),
u(x,"div","label-75",J.floor(m/4).toString()),u(x,"div","label-100","0"),x.style.width=d.offsetWidth+"px",d=x.offsetWidth+fa(x,"margin-right",!0)):x.parentNode.removeChild(x);if(0===m)a.currentView.chartContents.style.minHeight=a.currentView.mapContents.offsetHeight+"px",l.parentNode.removeChild(l),b=u(a.currentView.chartContents,"div","no-data-message",g.noChartDataMessage),f&&w(b,"view-switch");else{l=a.currentView.mapContents.offsetHeight/m;for(m=x=f=0;12>m;m++)if(ea(a.views.chart.monthsToShow,
m))for(F=X(h,m),C=1,f++,z=0;z<F;z++)a.views.chart.daysToShow.indexOf(C)>G.notFound&&Ma(b,a,z+1,m,h,e,l),0===(z+1)%7&&(C=0),C++,x++;if(a.views.chart.showMonthNames){e=n(a.currentView.chartContents,"div","chart-months");f=b.offsetWidth/f;for(l=h=0;12>l;l++)ea(a.views.chart.monthsToShow,l)&&(u(e,"div","month-name",g.monthNames[l]).style.left=d+f*h+"px",h++);e.style.width=b.offsetWidth+"px";b=n(e,"div","month-name-space");b.style.height=e.offsetHeight+"px";b.style.width=d+"px"}a.keepScrollPositions&&
(a.currentView.chartContents.scrollLeft=a.currentView.chartContentsScrollLeft)}a.currentView.chartContents.style.display="none"}if(a.views.statistics.enabled){h=n(a.currentView.statisticsContents,"div","statistics");b=n(a.currentView.statisticsContents,"div","statistics-ranges");l=n(h,"div","y-labels");e=n(h,"div","range-lines");d=da(a);f={};x=0;m=Q(a);for(F=f["0"]=0;12>F;F++)for(C=X(a.currentView.year,F),z=0;z<C;z++)H=R(new Date(a.currentView.year,F,z+1)),m.hasOwnProperty(H)&&(I=H.split(p.dash),
I=new Date(I[2],I[1],I[0]),P=na(I),!za(a,I)&&ea(a.views.statistics.monthsToShow,I.getMonth())&&a.views.statistics.daysToShow.indexOf(P)>G.notFound&&(H=oa(a,d,m[H]),q(H)?(f.hasOwnProperty(H.minimum.toString())||(f[H.minimum.toString()]=0),f[H.minimum]++,x=J.max(x,f[H.minimum])):f["0"]++));c&&w(h,"view-switch");0<x&&a.views.statistics.showChartYLabels?(m=u(l,"div","label-0",x.toString()),u(l,"div","label-25",(3*J.floor(x/4)).toString()),u(l,"div","label-50",J.floor(x/2).toString()),u(l,"div","label-75",
...
if(a.showYearSelectionDropDown){n(a.currentView.yearText,"div","down-arrow");c=n(a.currentView.yearText,"div","years-list");d=n(c,"div","years");var e=(new Date).getFullYear(),f=null;c.style.display="block";c.style.visibility="hidden";for(var h=e-a.extraSelectionYears;h<e+a.extraSelectionYears;h++)if(a.yearsToHide.indexOf(h)===G.notFound){var l=Qa(a,d,h);q(f)||(f=l)}q(f)&&(d.scrollTop=f.offsetTop-d.offsetHeight/2);c.style.display="none";c.style.visibility="visible"}else w(a.currentView.yearText,"no-click");
...
d=b);return d}function Ja(a,b,c,d,e,f){c+=1;b=n(b,"div","day");var h=new Date(e,d,c),l=k[a.currentView.element.id].type[a.currentView.type][R(h)];l=Z(l)?l:0;L(a.onDayToolTipRender)?V(b,a,r(a.onDayToolTipRender,h,l)):V(b,a,Ba(a.dayToolTipText,h));a.views.map.showDayNumbers&&0<l&&(b.innerHTML=l.toString());L(a.onDayClick)?b.onclick=function(){r(a.onDayClick,h,l)}:w(b,"no-hover");d=oa(a,f,l,h);q(d)&&ha(a,d.id)&&(A(d.mapCssClassName)?w(b,d.mapCssClassName):w(b,d.cssClassName));return b}function Ma(a,
b,c,d,e,f,h){var l=new Date(e,d,c);a=n(a,"div","day-line");var m=Q(b)[R(l)];m=Z(m)?m:0;L(b.onDayToolTipRender)?V(a,b,r(b.onDayToolTipRender,l,m)):V(a,b,Ba(b.dayToolTipText,l));b.views.chart.showLineNumbers&&0<m&&(w(a,"day-line-number"),a.innerHTML=m.toString());h*=m;a.style.height=h+"px";0>=h&&(a.style.visibility="hidden");L(b.onDayClick)?a.onclick=function(){r(b.onDayClick,l,m)}:w(a,"no-hover");f=oa(b,f,m,l);q(f)&&ha(b,f.id)&&(A(f.chartCssClassName)?w(a,f.chartCssClassName):w(a,f.cssClassName))}
function Na(a,b,c,d,e,f){b=n(b,"div","range-line");var h=Ra(e,a);a=c*f;b.style.height=a+"px";0>=a&&(b.style.visibility="hidden");V(b,d,c.toString());L(d.onStatisticClick)?b.onclick=function(){r(d.onStatisticClick,h)}:w(b,"no-hover");q(h)&&ha(d,h.id)&&(A(h.statisticsCssClassName)?w(b,h.statisticsCssClassName):w(b,h.cssClassName))}function Ia(a){var b=n(a.currentView.element,"div","guide"),c=n(b,"div","map-types"),d=0;for(e in k[a.currentView.element.id].type[g.unknownTrendText])if(k[a.currentView.element.id].type[g.unknownTrendText].hasOwnProperty(e)){d++;
break}if(1<k[a.currentView.element.id].types){if(A(a.descriptionText)){var e=n(a.currentView.element,"div","description",b);Ca(a,e)}for(var f in k[a.currentView.element.id].type)if(f!==g.unknownTrendText||0<d)0===d&&a.currentView.type===g.unknownTrendText&&(a.currentView.type=f),Sa(a,c,f)}else Ca(a,c);if(a.showGuide){b=n(b,"div","map-toggles");a.showLessAndMoreLabels&&(c=u(b,"div","less-text",g.lessText),a.mapTogglesEnabled?c.onclick=function(){Da(a,!1)}:w(c,"no-click"));c=n(b,"div","days");d=da(a);
f=d.length;for(e=0;e<f;e++)Ta(a,c,d[e]);a.showLessAndMoreLabels&&(b=u(b,"div","more-text",g.moreText),a.mapTogglesEnabled?b.onclick=function(){Da(a,!0)}:w(b,"no-click"))}}function Sa(a,b,c){b=u(b,"button","type",c);a.currentView.type===c&&w(b,"active");b.onclick=function(){a.currentView.type!==c&&(a.currentView.type=c,r(a.onTypeSwitch,c),y(a))}}function Ta(a,b,c){b=n(b,"div");b.className="day";V(b,a,c.tooltipText);ha(a,c.id)&&(1===a.currentView.view&&A(c.mapCssClassName)?w(b,c.mapCssClassName):a.views.chart.enabled&&
2===a.currentView.view&&A(c.chartCssClassName)?w(b,c.chartCssClassName):a.views.statistics.enabled&&3===a.currentView.view&&A(c.statisticsCssClassName)?w(b,c.statisticsCssClassName):w(b,c.cssClassName));a.showNumbersInGuide&&(w(b,"day-number"),b.innerHTML=c.minimum+p.plus);a.mapTogglesEnabled?b.onclick=function(){for(var d=c.id,e=a.colorRanges.length,f=0;f<e;f++){var h=a.colorRanges[f];if(h.id===d){h.visible=!(M(h.visible)&&h.visible);r(a.onColorRangeTypeToggle,h.id,h.visible);y(a);break}}}:w(b,"no-hover")}
function Ca(a,b){if(A(a.descriptionText))if(A(a.descriptionTextLink)){var c=u(b,"a","label",a.descriptionText);c.href=a.descriptionTextLink;c.target="_blank"}else u(b,"span","label",a.descriptionText)}function ha(a,b){var c=!1;if("HOLIDAY"===b)c=!0;else for(var d=a.colorRanges.length,e=0;e<d;e++){var f=a.colorRanges[e];if(f.id===b&&(!M(f.visible)||f.visible)){c=!0;break}}return c}function Da(a,b){for(var c=a.colorRanges.length,d=0;d<c;d++)a.colorRanges[d].visible=b,r(a.onColorRangeTypeToggle,a.colorRanges[d].id,
b);y(a)}function oa(a,b,c,d){var e=null;q(d)&&za(a,d)&&(e={cssClassName:"holiday",id:"HOLIDAY",visible:!0});if(!q(e))for(a=b.length,d=0;d<a;d++){var f=b[d];if(c>=f.minimum)e=f;else break}return e}function Ra(a,b){for(var c=a.length,d=null,e=0;e<c;e++){var f=a[e];if(b.toString()===f.minimum.toString()){d=f;break}}return d}function da(a){return a.colorRanges.sort(function(b,c){return b.minimum-c.minimum})}function za(a,b){for(var c=a.holidays.length,d=!1,e=b.getDate(),f=b.getMonth()+1,h=b.getFullYear(),
l=0;l<c;l++){var m=a.holidays[l];if(A(m.date)&&m.showInViews&&(m=m.date.split("/"),2===m.length?d=e===parseInt(m[0])&&f===parseInt(m[1]):3===m.length&&(d=e===parseInt(m[0])&&f===parseInt(m[1])&&h===parseInt(m[2])),d))break}return d}function ma(a,b){b.allowFileImports&&(a.ondragover=Y,a.ondragenter=Y,a.ondragleave=Y,a.ondrop=function(c){Y(c);q(B.FileReader)&&0<c.dataTransfer.files.length&&Ea(c.dataTransfer.files,b)})}function Pa(a){var b=Ua("input");b.type="file";b.accept=".json, .txt";b.multiple=
"multiple";b.onchange=function(){Ea(b.files,a)};b.click()}function Ea(a,b){for(var c=a.length,d=[],e=Q(b),f=function(F,C){d.push(F);for(var z in C)C.hasOwnProperty(z)&&(e.hasOwnProperty(z)||(e[z]=0),e[z]+=C[z]);d.length===c&&(r(b.onImport,b.currentView.element),y(b))},h=0;h<c;h++){var l=a[h],m=l.name.split(".").pop().toLowerCase();"json"===m?Va(l,f):"txt"===m&&Wa(l,f)}}function Va(a,b){var c=new FileReader,d=null;c.readAsText(a);c.onloadend=function(){b(a.name,d)};c.onload=function(e){e=la(e.target.result);
e.parsed&&K(e.result)&&(d=e.result)}}function Wa(a,b){var c=new FileReader,d={};c.readAsText(a);c.onloadend=function(){b(a.name,d)};c.onload=function(e){e=e.target.result.toString().split(p.newLine);for(var f=e.length,h=0;h<f;h++){var l=e[h].split(":");d[l[0].trim()]=parseInt(l[1].trim())}}}function Aa(a){var b=null;var c=null;"csv"===a.exportType.toLowerCase()?c="text/csv":"json"===a.exportType.toLowerCase()?c="application/json":"xml"===a.exportType.toLowerCase()?c="application/xml":"txt"===a.exportType.toLowerCase()&&
(c="text/plain");if("csv"===a.exportType.toLowerCase()){var d=ia(a),e=[];for(f in d)d.hasOwnProperty(f)&&e.push([ja(f),ja(d[f])].join());0<e.length&&e.unshift([ja(g.dateText),ja(g.countText)].join());b=e.join(p.newLine)}else if("json"===a.exportType.toLowerCase())b=ba.stringify(ia(a));else if("xml"===a.exportType.toLowerCase()){var f=ia(a);e=[];e.push('<?xml version="1.0" ?>');e.push("<Dates>");for(d in f)f.hasOwnProperty(d)&&(e.push("<Date>"),e.push("<FullDate>"+d+"</FullDate>"),e.push("<Count>"+
f[d]+"</Count>"),e.push("</Date>"));e.push("</Dates>");b=e.join(p.newLine)}else if("txt"===a.exportType.toLowerCase()){f=ia(a);d=[];for(e in f)f.hasOwnProperty(e)&&d.push(e+": "+f[e].toString());b=d.join(p.newLine)}b!==p.empty&&(f=n(E.body,"a"),f.style.display="none",f.setAttribute("target","_blank"),f.setAttribute("href","data:"+c+";charset=utf-8,"+encodeURIComponent(b)),c=f.setAttribute,e=new Date,d=N(e.getDate())+p.dash+N(e.getMonth()+1)+p.dash+e.getFullYear(),e=N(e.getHours())+p.dash+N(e.getMinutes()),
b=p.empty,a.currentView.type!==g.unknownTrendText&&(b=a.currentView.type.toLowerCase().replace(p.space,p.underscore)+p.underscore),d=b+d+p.underscore+e+"."+a.exportType.toLowerCase(),c.call(f,"download",d),f.click(),E.body.removeChild(f),r(a.onExport,a.currentView.element))}function ia(a){var b={},c=Q(a);if(a.exportOnlyYearBeingViewed)for(var d=0;12>d;d++)for(var e=X(a.currentView.year,d),f=0;f<e;f++){var h=R(new Date(a.currentView.year,d,f+1));c.hasOwnProperty(h)&&(b[h]=c[h])}else{a=[];for(d in c)c.hasOwnProperty(d)&&
a.push(d);a.sort();d=a.length;for(e=0;e<d;e++)f=a[e],c.hasOwnProperty(f)&&(b[f]=c[f])}return b}function ja(a){a=a.toString().replace(/(\r\n|\n|\r)/gm,p.empty).replace(/(\s\s)/gm,p.space);a=a.replace(/"/g,'""');return'"'+a+'"'}function va(a){a=K(a)?a:{};a.views=K(a.views)?a.views:{};a.showGuide=v(a.showGuide,!0);a.showTitle=v(a.showTitle,!0);a.showYearSelector=v(a.showYearSelector,!0);a.showRefreshButton=v(a.showRefreshButton,!1);a.showExportButton=v(a.showExportButton,!1);a.mapTogglesEnabled=v(a.mapTogglesEnabled,
...
null);return a}function X(a,b){return(new Date(a,b+1,0)).getDate()}function na(a){return 0>a.getDay()-1?6:a.getDay()-1}function Ba(a,b){var c=a,d=na(b);c=c.replace("{dddd}",g.dayNames[d]);c=c.replace("{dd}",N(b.getDate()));c=c.replace("{d}",b.getDate());d=c.replace;var e=b.getDate(),f=g.thText;if(31===e||21===e||1===e)f=g.stText;else if(22===e||2===e)f=g.ndText;else if(23===e||3===e)f=g.rdText;c=d.call(c,"{o}",f);c=c.replace("{mmmm}",g.monthNames[b.getMonth()]);c=c.replace("{mm}",N(b.getMonth()+1));
...
k[a].options;c.currentView.type!==b&&(c.currentView.type=b,r(c.onTypeSwitch,b),y(c))}return this};this.updateOptions=function(a,b){if(k.hasOwnProperty(a)&&K(b)){var c=k[a].options,d=va(b),e;for(e in d)d.hasOwnProperty(e)&&c.hasOwnProperty(e)&&(c[e]=d[e]);y(c,!0);r(c.onRefresh,c.currentView.element)}return this};this.destroyAll=function(){for(var a in k)if(k.hasOwnProperty(a)){var b=k[a].options;b.currentView.element.innerHTML=p.empty;b.currentView.element.className=p.empty;E.body.removeChild(b.currentView.tooltip);
r(b.onDestroy,b.currentView.element)}k={};return this};this.destroy=function(a){if(k.hasOwnProperty(a)){var b=k[a].options;b.currentView.element.innerHTML=p.empty;b.currentView.element.className=p.empty;E.body.removeChild(b.currentView.tooltip);r(b.onDestroy,b.currentView.element);delete k[a]}return this};this.setConfiguration=function(a,b){b=q(b)?b:!0;for(var c in a)a.hasOwnProperty(c)&&(g[c]=a[c]);Fa(g);b&&this.refreshAll();return this};this.getIds=function(){var a=[],b;for(b in k)k.hasOwnProperty(b)&&
a.push(b);return a};this.getVersion=function(){return"2.4.0"};(function(a,b,c,d){E=a;B=b;J=c;ba=d;Fa();E.addEventListener("DOMContentLoaded",function(){sa()});q(B.$heat)||(B.$heat=this)})(document,window,Math,JSON)})();