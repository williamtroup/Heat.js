...
r.empty?a.currentView.element.className="heat-js":z(a.currentView.element,"heat-js");a.currentView.element.removeAttribute("data-heat-options");qa(a.currentView.element.id,a);A(a);y(a.onRenderComplete,a.currentView.element)}function A(a,b,c){b=p(b,!1);c=p(c,!1);if(b&&a.useLocalStorageForData&&C.localStorage){b=a.currentView.element.id;if(a.useLocalStorageForData&&C.localStorage){for(var d=C.localStorage.length,e=[],f=a.currentView.element.id,g=0;g<d;g++)Fa(C.localStorage.key(g),"HJS_"+f)&&e.push(C.localStorage.key(g));
d=e.length;for(f=0;f<d;f++)C.localStorage.removeItem(e[f])}e=ha.stringify(k[b].type);C.localStorage.setItem("HJS_"+b,e)}v(a.currentView.mapContents)&&(a.currentView.mapContentsScrollLeft=a.currentView.mapContents.scrollLeft);a.views.chart.enabled&&v(a.currentView.chartContents)&&(a.currentView.chartContentsScrollLeft=a.currentView.chartContents.scrollLeft);a.views.statistics.enabled&&v(a.currentView.statisticsContents)&&(a.currentView.statisticsContentsScrollLeft=a.currentView.statisticsContents.scrollLeft);
...
(c=ta(a,c),c.matched&&u(c.name)&&(d+=r.colon+r.space+c.name));aa(b,a,d)}}function qa(a,b,c){c=p(c,!0);k[a]={options:b,type:{},types:1};k[a].type[h.unknownTrendText]={};if(c&&!b.currentView.isInFetchMode&&b.useLocalStorageForData&&C.localStorage)for(a=C.localStorage.length,b=b.currentView.element.id,c=0;c<a;c++){var d=C.localStorage.key(c);if(Fa(d,"HJS_")&&(d=C.localStorage.getItem(d),d=pa(d),d.parsed)){k[b].type=d.result;k[b].types=0;for(var e in k[b].type)k[b].type.hasOwnProperty(e)&&k[b].types++}}}
...
a&&a!==r.empty}function I(a){return v(a)&&"object"===typeof a}function ya(a){return v(a)&&"boolean"===typeof a}function u(a){return v(a)&&"string"===typeof a}function P(a){return v(a)&&"function"===typeof a}function na(a){return v(a)&&"number"===typeof a}function W(a){return I(a)&&a instanceof Array}function oa(a){return I(a)&&a instanceof Date}function gb(a){a=a.toLowerCase();var b="text"===a;ba.hasOwnProperty(a)||(ba[a]=b?H.createTextNode(r.empty):H.createElement(a));return ba[a].cloneNode(!1)}
function q(a,b,c,d){b=b.toLowerCase();var e="text"===b;ba.hasOwnProperty(b)||(ba[b]=e?H.createTextNode(r.empty):H.createElement(b));b=ba[b].cloneNode(!1);v(c)&&(b.className=c);v(d)?a.insertBefore(b,d):a.appendChild(b);return b}function w(a,b,c,d,e){a=q(a,b,c,e);a.innerHTML=d;return a}function ja(a,b,c){var d=null;c=p(c,!1);C.getComputedStyle?d=H.defaultView.getComputedStyle(a,null).getPropertyValue(b):a.currentStyle&&(d=a.currentStyle[b]);c&&(d=parseFloat(d,10));return d}function z(a,b){a.className+=
r.space+b;a.className=a.className.trim()}function ea(a){a.preventDefault();a.cancelBubble=!0}function S(a){for(var b=a.children,c=b.length-1;c--;)a.appendChild(b[c])}function va(a,b,c,d){a=q(a,"div");a=q(a,"label","checkbox");var e=q(a,"input");e.type="checkbox";v(d)&&(e.onclick=d);v(c)&&(e.checked=c);q(a,"span","check-mark");w(a,"span","text",b);return{input:e,label:a}}function y(a){var b=null;P(a)&&(b=a.apply(null,[].slice.call(arguments,1)));return b}function t(a,b){return u(a)?a:b}function p(a,
b){return ya(a)?a:b}function D(a,b){return P(a)?a:b}function V(a,b){return na(a)?a:b}function pa(a){var b=!0,c=null;try{u(a)&&(c=ha.parse(a))}catch(d){try{c=eval("("+a+")"),P(c)&&(c=c())}catch(e){h.safeMode||(console.error(h.objectErrorText.replace("{{error_1}}",d.message).replace("{{error_2}}",e.message)),b=!1),c=null}}return{parsed:b,result:c}}function X(){for(var a=[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push(r.dash);var c=K.floor(16*K.random()).toString(16);a.push(c)}return a.join(r.empty)}
