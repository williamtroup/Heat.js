...
function(a){f=J(a)?a:{};Z();return this};this.getVersion=function(){return"1.3.0"};(function(a,b){B=a;N=b;Z();B.addEventListener("DOMContentLoaded",function(){S()});u(N.$heat)||(N.$heat=this)})(document,window)})();