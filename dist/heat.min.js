...
Ra(k[a].options);k={};return p};p.destroy=function(a){u(a)&&k.hasOwnProperty(a)&&(Ra(k[a].options),delete k[a]);return p};p.setConfiguration=function(a,b){if(M(a)){var d=!1,c;for(c in a)a.hasOwnProperty(c)&&h.hasOwnProperty(c)&&h[c]!==a[c]&&(h[c]=a[c],d=!0);d&&(b=m(b,!0),Sa(h),b&&p.refreshAll())}return p};p.getIds=function(){var a=[],b;for(b in k)k.hasOwnProperty(b)&&a.push(b);return a};p.getVersion=function(){return"4.0.0"};(function(a,b,d,c){K=a;C=b;J=d;ma=c;Sa();K.addEventListener("DOMContentLoaded",
