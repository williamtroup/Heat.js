...
(function(){function Ba(){for(var a=h.domElementTypes,b=a.length,c=0;c<b;c++){var d=J.getElementsByTagName(a[c]);d=[].slice.call(d);for(var e=d.length,f=0;f<e;f++){var g=d[f],l=!0;if(v(g)&&g.hasAttribute("data-heat-options")){var n=g.getAttribute("data-heat-options");u(n)?(n=pa(n),n.parsed&&H(n.result)?Ca(Da(n.result,g)):h.safeMode||(console.error(h.attributeNotValidErrorText.replace("{{attribute_name}}","data-heat-options")),l=!1)):h.safeMode||(console.error(h.attributeNotSetErrorText.replace("{{attribute_name}}",
...
"month");var n=q(g,"div","day-columns");var x=da(l,f),C=q(n,"div","day-column"),E=!1,I=sa(new Date(l,f,1)),F=1;x+=I;for(var G=0;G<x;G++){G>=I?E=!0:a.views.map.daysToShow.indexOf(F)>L.notFound&&q(C,"div","day-disabled");if(E){var M=null;a.views.map.daysToShow.indexOf(F)>L.notFound&&(M=Va(a,C,G-I,f,l,d));if(0===(G+1)%7&&(a.views.map.showDaysInReverseOrder&&S(C),C=q(n,"div","day-column"),F=0,!v(Z)&&v(M))){var Wa=ja(M,"margin-left",!0),Xa=ja(M,"margin-right",!0);Z=M.offsetWidth+Wa+Xa}}F++}a.views.map.showMonthNames&&
(C=g.offsetWidth,x=a.views.map.placeMonthNamesOnTheBottom?w(g,"div","month-name-bottom",h.monthNames[f]):w(g,"div","month-name",h.monthNames[f],n),v(x)&&(x.style.width=a.views.map.showMonthDayGaps?C+"px":C-Z+"px"));b&&v(Z)&&(0<I&&!a.views.map.showMonthDayGaps?g.style.marginLeft=-Z+"px":0===I&&a.views.map.showMonthDayGaps&&(g.style.marginLeft=Z+"px"));a.views.map.showMonthsInReverseOrder&&S(n);b=!0}a.views.map.showMonthsInReverseOrder&&S(e);a.keepScrollPositions&&(a.currentView.mapContents.scrollLeft=
a.currentView.mapContentsScrollLeft)}a.views.chart.enabled&&(Ya(a,c),a.currentView.chartContents.style.display="none");if(a.views.statistics.enabled){d=c;f=q(a.currentView.statisticsContents,"div","statistics");c=q(a.currentView.statisticsContents,"div","statistics-ranges");g=q(f,"div","y-labels");l=q(f,"div","range-lines");b=ia(a);e={};n=0;I=N(a);for(x=e[r.zero]=0;12>x;x++)for(C=da(a.currentView.year,x),E=0;E<C;E++)F=O(new Date(a.currentView.year,x,E+1)),I.hasOwnProperty(F)&&(G=F.split(r.dash),G=
new Date(G[2],G[1],G[0]),M=sa(G),!ta(a,G).matched&&ca(a.views.statistics.monthsToShow,G.getMonth())&&a.views.statistics.daysToShow.indexOf(M)>L.notFound&&(F=ua(a,b,I[F]),v(F)?(e.hasOwnProperty(F.minimum.toString())||(e[F.minimum.toString()]=0),e[F.minimum]++,n=K.max(n,e[F.minimum])):e[r.zero]++));d&&z(f,"view-switch");0<n&&a.views.statistics.showChartYLabels?(I=w(g,"div","label-0",n.toString()),w(g,"div","label-25",(3*K.floor(n/4)).toString()),w(g,"div","label-50",K.floor(n/2).toString()),w(g,"div",
"label-75",K.floor(n/4).toString()),w(g,"div","label-100",r.zero),g.style.width=I.offsetWidth+"px",c.style.paddingLeft=g.offsetWidth+ja(g,"margin-right",!0)+"px"):g.parentNode.removeChild(g);if(0===n){a.currentView.statisticsContents.style.minHeight=a.currentView.mapContents.offsetHeight+"px";f.parentNode.removeChild(f);c.parentNode.removeChild(c);var T=w(a.currentView.statisticsContents,"div","no-statistics-message",h.noStatisticsDataMessage);d&&z(T,"view-switch")}else{d=a.currentView.mapContents.offsetHeight/
...
e=w(a.currentView.chartContents,"div","no-data-message",h.noChartDataMessage),b&&z(e,"view-switch");else{b=a.currentView.mapContents.offsetHeight/g;for(g=d=c=0;12>g;g++)if(ca(a.views.chart.monthsToShow,g)){x=da(l,g);var C=1;c++;for(var E=0;E<x;E++)a.views.chart.daysToShow.indexOf(C)>L.notFound&&db(e,a,E+1,g,l,f,b),0===(E+1)%7&&(C=0),C++,d++}a.views.chart.showInReverseOrder&&S(e);if(a.views.chart.showMonthNames){var I=q(a.currentView.chartContents,"div","chart-months"),F=e.offsetWidth/c,G=0;f=function(M){ca(a.views.chart.monthsToShow,
...
(c=ta(a,c),c.matched&&u(c.name)&&(d+=r.colon+r.space+c.name));aa(b,a,d)}}function qa(a,b,c){c=p(c,!0);k[a]={options:b,type:{},types:1};k[a].type[h.unknownTrendText]={};if(c&&!b.currentView.isInFetchMode&&b.useLocalStorageForData&&B.localStorage)for(a=B.localStorage.length,b=b.currentView.element.id,c=0;c<a;c++){var d=B.localStorage.key(c);if(Fa(d,"HJS_")&&(d=B.localStorage.getItem(d),d=pa(d),d.parsed)){k[b].type=d.result;k[b].types=0;for(var e in k[b].type)k[b].type.hasOwnProperty(e)&&k[b].types++}}}
...
d.date=t(d.date,null),d.name=t(d.name,null),d.showInViews=p(d.showInViews,!0);else a.holidays=[];a.views.map=H(a.views.map)?a.views.map:{};a.views.map.showMonthDayGaps=p(a.views.map.showMonthDayGaps,!0);a.views.map.showDayNames=p(a.views.map.showDayNames,!0);a.views.map.placeMonthNamesOnTheBottom=p(a.views.map.placeMonthNamesOnTheBottom,!1);a.views.map.showDayNumbers=p(a.views.map.showDayNumbers,!1);a.views.map.showMonthNames=p(a.views.map.showMonthNames,!0);a.views.map.showDaysInReverseOrder=p(a.views.map.showDaysInReverseOrder,
!1);a.views.map.showNoDataMessageWhenDataIsNotAvailable=p(a.views.map.showNoDataMessageWhenDataIsNotAvailable,!1);a.views.map.showMinimalDayNames=p(a.views.map.showMinimalDayNames,!1);a.views.map.showMonthsInReverseOrder=p(a.views.map.showMonthsInReverseOrder,!1);R(a.views.map.monthsToShow)&&(a.views.map.monthsToShow=za);R(a.views.map.daysToShow)&&(a.views.map.daysToShow=Aa);a.views.chart=H(a.views.chart)?a.views.chart:{};a.views.chart.enabled=p(a.views.chart.enabled,!0);a.views.chart.showChartYLabels=
p(a.views.chart.showChartYLabels,!0);a.views.chart.showMonthNames=p(a.views.chart.showMonthNames,!0);a.views.chart.showLineNumbers=p(a.views.chart.showLineNumbers,!1);a.views.chart.showInReverseOrder=p(a.views.chart.showInReverseOrder,!1);R(a.views.chart.monthsToShow)&&(a.views.chart.monthsToShow=za);R(a.views.chart.daysToShow)&&(a.views.chart.daysToShow=Aa);a.views.statistics=H(a.views.statistics)?a.views.statistics:{};a.views.statistics.enabled=p(a.views.statistics.enabled,!0);a.views.statistics.showChartYLabels=
...
1}function v(a){return null!==a&&void 0!==a&&a!==r.empty}function H(a){return v(a)&&"object"===typeof a}function ya(a){return v(a)&&"boolean"===typeof a}function u(a){return v(a)&&"string"===typeof a}function P(a){return v(a)&&"function"===typeof a}function na(a){return v(a)&&"number"===typeof a}function W(a){return H(a)&&a instanceof Array}function oa(a){return H(a)&&a instanceof Date}function gb(a){a=a.toLowerCase();var b="text"===a;ba.hasOwnProperty(a)||(ba[a]=b?J.createTextNode(r.empty):J.createElement(a));
...
a:b}function p(a,b){return ya(a)?a:b}function D(a,b){return P(a)?a:b}function V(a,b){return na(a)?a:b}function pa(a){var b=!0,c=null;try{u(a)&&(c=ha.parse(a))}catch(d){try{c=eval("("+a+")"),P(c)&&(c=c())}catch(e){h.safeMode||(console.error(h.objectErrorText.replace("{{error_1}}",d.message).replace("{{error_2}}",e.message)),b=!1),c=null}}return{parsed:b,result:c}}function X(){for(var a=[],b=0;32>b;b++){8!==b&&12!==b&&16!==b&&20!==b||a.push(r.dash);var c=K.floor(16*K.random()).toString(16);a.push(c)}return a.join(r.empty)}
