...
(() => {
    ...
    function te(e) {
        ...
        if (!o.definedParentElement(e._currentView.confirmationDialog)) {
            ...
            const i = a.createButton(o, "button", "", x.text.noButtonText);
            e._currentView.confirmationDialogYesButton = a.createButton(o, "button", "default", x.text.yesButtonText);
            i.onclick = () => oe(e);
        }
    }
    function ne(e, t, n) {
    ...
    function se(e, t) {
        ...
        if (e.views.map.enabled) {
            const t = ae(e, i, x.text.mapText);
            le(e, t, 1, "map");
        }
        if (e.views.line.enabled) {
            const t = ae(e, i, x.text.lineText);
            le(e, t, 2, "line");
        }
        if (e.views.chart.enabled) {
            const t = ae(e, i, x.text.chartText);
            le(e, t, 3, "chart");
        }
        let r = null;
        if (e.views.days.enabled) {
            ...
            const t = ae(e, i, x.text.daysText);
            le(e, t, 4, "days");
        }
        if (e.views.months.enabled) {
            ...
            const t = ae(e, i, x.text.monthsText);
            le(e, t, 5, "months");
        }
        if (e.views.colorRanges.enabled) {
            ...
            const t = ae(e, i, x.text.colorRangesText);
    ...
    function pe(e, t, l, d, u, g) {
        ...
        const y = i.getNumber(ze(e)[s.toStorageDate(m)], 0);
    ...
    function Te(e, t, l, d, u, g, f) {
        ...
        const y = i.getNumber(ze(t)[s.toStorageDate(h)], 0);
    ...
    function He(e, t, n, i, a, d, u, w, g, f) {
