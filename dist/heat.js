...
(() => {
    ...
    function Q(e) {
        ...
        if (!o.definedParentElement(e._currentView.typeAddingDialog)) {
            ...
            const i = a.create(n, "div", "buttons");
            const r = a.createButton(i, "button", "default", u.text.addButtonText);
    ...
    function ve(e, t, d, g, f, h) {
        ...
        const T = i.getNumber(We(e)[s.toStorageDate(y)], 0);
    ...
    function Ve(e, t, d, g, f, h, m) {
        ...
        const b = i.getNumber(We(t)[s.toStorageDate(p)], 0);
    ...
    function Ce(e, t, d, g, f, h, m, p) {
        ...
        const V = i.getNumber(We(t)[s.toStorageDate(y)], 0);
