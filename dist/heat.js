...
(() => {
    ...
    function S(e) {
        ...
        if (o.defined(e) && e.hasAttribute(n.Attribute.HEAT_JS)) {
            ...
            if (o.definedString(r)) {
                const s = i.getObjectFromString(r, C);
                if (s.parsed && o.definedObject(s.object)) {
                    M(g.Options.getForNewInstance(C, s.object, e));
                } else {
                    if (!C.safeMode) {
    ...
    function k(e) {
        ...
        if (!o.definedParentElement(e._currentView.configurationDialog)) {
            ...
            a.createWithHTML(t, "span", "dialog-title-bar-text", C.text.configurationTitleText);
            a.createWithHTML(r, "div", "side-container-title-text", `${C.text.visibleDaysText}${":"}`);
            a.createWithHTML(s, "div", "side-container-title-text", `${C.text.visibleMonthsText}${":"}`);
            const c = a.create(s, "div", "side-container");
            const d = a.create(s, "div", "side-container");
            const u = a.create(n, "div", "buttons");
            const w = a.createButton(u, "button", "", C.text.resetButtonText);
            const g = a.createButton(u, "button", "default", C.text.saveButtonText);
            o.onclick = () => L(e);
            w.onclick = () => R(e);
            g.onclick = () => A(e);
            for (let t = 0; t < 7; t++) {
                e._currentView.configurationDialogDayCheckBoxes[t] = a.createCheckBox(r, C.text.dayNames[t], t.toString());
            }
            let f = c;
            let h = 0;
            for (let t = e.startMonth; t < 12 + e.startMonth; t++) {
                ...
                e._currentView.configurationDialogMonthCheckBoxes[n] = a.createCheckBox(f, C.text.monthNames[n], n.toString());
                h++;
                if (h > 6) {
                    f = d;
                }
    ...
    function I(e) {
        ...
        if (!o.definedParentElement(e._currentView.exportDialog)) {
            ...
            const o = a.create(t, "div", "dialog-close");
            a.createWithHTML(t, "span", "dialog-title-bar-text", C.text.selectTypeText);
            ...
            e._currentView.exportDialogExportOnlyDataBeingViewedCheckBox = a.createCheckBox(n, C.text.onlyDataBeingViewedText, crypto.randomUUID());
            ...
            const r = a.createButton(i, "button", "", C.text.copyButtonText);
            const s = a.createButton(i, "button", "default", C.text.exportButtonText);
            F(e);
    ...
    function Y(e, t = null, n = null, r = true, s = false) {
        ...
        const d = j(e, r);
        const u = y.Contents.get(l, d, C, e);
    ...
    function W(e) {
        ...
        if (!o.definedParentElement(e._currentView.importDialog)) {
            ...
            const o = a.create(t, "div", "dialog-close");
            a.createWithHTML(t, "span", "dialog-title-bar-text", C.text.selectFilesText);
            e._currentView.importDialogDragAndDrop = a.createWithHTML(n, "div", "drag-and-drop-files", C.text.dragAndDropFilesText);
            e._currentView.importDialogClearExistingData = a.createCheckBox(n, C.text.clearExistingDataText, crypto.randomUUID());
            U(e._currentView.importDialogDragAndDrop, e);
            const i = a.create(n, "div", "buttons");
            const r = a.createButton(i, "button", "", C.text.browseButtonText);
            e._currentView.importDialogImportButton = a.createButton(i, "button", "default", C.text.importButtonText);
    ...
    function q(e) {
        ...
        if (!o.definedParentElement(e._currentView.typeAddingDialog)) {
            ...
            const o = a.create(t, "div", "dialog-close");
            a.createWithHTML(t, "span", "dialog-title-bar-text", C.text.addTypeText);
            ...
            e._currentView.typeAddingOptionNewType = a.createCheckBox(n, C.text.openNewTypeText, crypto.randomUUID());
            e._currentView.typeAddingOptionNewType.checked = true;
            const i = a.create(n, "div", "buttons");
            const r = a.createButton(i, "button", "default", C.text.addButtonText);
    ...
    function te(e) {
        ...
        if (!o.definedParentElement(e._currentView.confirmationDialog)) {
            ...
            a.createWithHTML(t, "span", "dialog-title-bar-text", C.text.confirmText);
            e._currentView.confirmationDialogMessage = a.create(n, "div", "message");
            const o = a.create(n, "div", "buttons");
            const i = a.createButton(o, "button", "", C.text.noButtonText);
            e._currentView.confirmationDialogYesButton = a.createButton(o, "button", "default", C.text.yesButtonText);
            i.onclick = () => oe(e);
        }
    }
    function ne(e, t, n) {
        ...
        if (e.title.showText || e.title.showYearSelector || e.title.showRefreshButton || e.title.showExportButton || e.title.showImportButton || e.title.showClearButton) {
            ...
            if (e.title.showText) {
                ...
                if (e.title.showSectionText) {
                    ...
                    a.createWithHTML(n, "span", "section-text-name", m.View.getText(e, C));
                    a.createWithHTML(n, "span", "section-text", "]");
                }
            }
            if (i) {
    ...
    function se(e, t) {
        ...
        if (e.title.showTitleDropDownHeaders) {
            a.createWithHTML(i, "div", "title-menu-header", `${C.text.dataText}${":"}`);
        }
        if (e.views.map.enabled) {
            const t = ae(e, i, C.text.mapText);
            le(e, t, 1, "map");
        }
        if (e.views.line.enabled) {
            const t = ae(e, i, C.text.lineText);
            le(e, t, 2, "line");
        }
        if (e.views.chart.enabled) {
            const t = ae(e, i, C.text.chartText);
            le(e, t, 3, "chart");
        }
        let r = null;
        if (e.views.days.enabled) {
            if (e.title.showTitleDropDownHeaders) {
                r = a.createWithHTML(i, "div", "title-menu-header", `${C.text.yearText}${":"}`);
            }
            const t = ae(e, i, C.text.daysText);
            le(e, t, 4, "days");
        }
        if (e.views.months.enabled) {
            ...
            const t = ae(e, i, C.text.monthsText);
            le(e, t, 5, "months");
        }
        if (e.views.colorRanges.enabled) {
            if (e.title.showTitleDropDownHeaders) {
                a.createWithHTML(i, "div", "title-menu-header", `${C.text.statisticsText}${":"}`);
            }
            const t = ae(e, i, C.text.colorRangesText);
    ...
    function ue(e) {
        ...
        if (e.yearlyStatistics.enabled && (!e.yearlyStatistics.showOnlyForCurrentYear || n)) {
            ...
            if (e.yearlyStatistics.showToday) {
                ...
                a.createWithHTML(d, "div", "statistics-box-title", `${C.text.todayText}${":"}`);
            ...
            if (e.yearlyStatistics.showThisWeek) {
                ...
                const d = a.create(i, "div", "statistics-box");
                a.createWithHTML(d, "div", "statistics-box-title", `${C.text.thisWeekText}${":"}`);
            ...
            if (e.yearlyStatistics.showThisMonth) {
                ...
                const d = n ? r.friendlyNumber(o) : C.text.unavailableText;
                const u = a.create(i, "div", "statistics-box");
                a.createWithHTML(u, "div", "statistics-box-title", `${C.text.thisMonthText}${":"}`);
            ...
            if (e.yearlyStatistics.showThisYear) {
                ...
                a.createWithHTML(e, "div", "statistics-box-title", `${C.text.thisYearText}${":"}`);
    ...
    function fe(e, t = false, i) {
        ...
        if (!ye(e)) {
            ...
            const o = a.createWithHTML(e._currentView.mapContents, "div", "no-data-message", C.text.noMapDataMessage);
            if (t) {
    ...
    function pe(e, t, l, d, u, g) {
        ...
        if (e.views.map.showDayDateNumbers) {
            ...
            a.createWithHTML(e, "sup", "", s.getDayOrdinal(C, f));
        }
    ...
    function ve(e, t, i) {
        ...
        if (d === 0) {
            ...
            const o = a.createWithHTML(e._currentView.lineContents, "div", "no-data-message", C.text.noLineDataMessage);
            if (t) {
                a.addClass(o, "view-switch");
            }
        } else {
    ...
    function be(e, t, i) {
        ...
        if (u === 0) {
            ...
            r.parentNode.removeChild(r);
            const o = a.createWithHTML(e._currentView.chartContents, "div", "no-data-message", C.text.noChartDataMessage);
            if (t) {
                a.addClass(o, "view-switch");
            }
        } else {
    ...
    function Ve(e, t, l, d, u, g, f, h) {
        ...
        if (t.views.chart.showLineDateNumbers) {
            ...
            a.createWithHTML(e, "sup", "", s.getDayOrdinal(C, l));
        }
    ...
    function Ce(e, t) {
        ...
        if (u.largestValue === 0) {
            ...
            i.parentNode.removeChild(i);
            r.parentNode.removeChild(r);
            const o = a.createWithHTML(e._currentView.daysContents, "div", "no-days-message", C.text.noDaysDataMessage);
            if (t) {
                a.addClass(o, "view-switch");
            }
        } else {
            ...
            for (const n in u.values) {
                if (Object.prototype.hasOwnProperty.call(u.values, n) && o.dayVisible(e.views.days.daysToShow, parseInt(n))) {
                    ...
                    const l = _e(c, parseInt(n), u.values[n].total, e, i, s, u.totalValue, t);
                    if (e.views.days.showDayNames) {
                        const t = a.createWithHTML(r, "div", "day-name", C.text.dayNames[parseInt(n) - 1]);
    ...
    function _e(e, t, i, u, w, g, f, h) {
        ...
        if (u.views.days.showToolTips) {
            let e = s.getCustomFormattedDateText(C, u.views.days.dayToolTipText, new Date(u._currentView.activeYear, 0, 1), false, t - 1);
    ...
    function xe(e, t) {
        ...
        if (u.largestValue === 0) {
            ...
            i.parentNode.removeChild(i);
            r.parentNode.removeChild(r);
            const o = a.createWithHTML(e._currentView.monthsContents, "div", "no-months-message", C.text.noMonthsDataMessage);
            if (t) {
                a.addClass(o, "view-switch");
            }
        } else {
            ...
            for (let n = e.startMonth; n < 12 + e.startMonth; n++) {
                ...
                if (Object.prototype.hasOwnProperty.call(u.values, f) && o.monthVisible(e.views.months.monthsToShow, g)) {
                    ...
                    if (e.views.months.showMonthNames) {
                        const e = a.createWithHTML(r, "div", "month-name", C.text.monthNames[g]);
    ...
    function Se(e, t, i, u, w, g, f, h) {
        ...
        if (u.views.months.showToolTips) {
            let e = s.getCustomFormattedDateText(C, u.views.months.monthToolTipText, new Date(u._currentView.activeYear, t - 1, 1));
            e += `${":"}${" "}<b class="tooltip-count">${r.friendlyNumber(i)}</b>`;
            l.add(m, u, e);
        }
    ...
    function Be(e, t) {
        ...
        if (d.largestValue === 0) {
            ...
            i.parentNode.removeChild(i);
            r.parentNode.removeChild(r);
            const o = a.createWithHTML(e._currentView.colorRangesContents, "div", "no-color-ranges-message", C.text.noColorRangesDataMessage);
            if (t) {
                a.addClass(o, "view-switch");
            }
        } else {
    ...
    function Ne(e) {
        ...
        if (e.guide.enabled) {
            ...
            if (e.guide.showInvertLabel) {
                const t = a.createWithHTML(n, "div", "invert-text", C.text.invertText);
            ...
            if (e.guide.showLessAndMoreLabels) {
                const t = a.createWithHTML(n, "div", "less-text", C.text.lessText);
                if (e.guide.colorRangeTogglesEnabled) {
            ...
            if (e.guide.showLessAndMoreLabels) {
                const t = a.createWithHTML(n, "div", "more-text", C.text.moreText);
                if (e.guide.colorRangeTogglesEnabled) {
                    t.onclick = () => nt(e, true);
                } else {
                    a.addClass(t, "no-click");
    ...
    function Ie(e, t, n) {
        if (e.zooming.enabled) {
            ...
            if (e.zooming.showResetButton) {
                ...
                l.add(s, e, C.text.resetButtonText);
                s.onclick = () => Ee(e);
            }
    ...
    function Ye(e, t, n, i, a, d, u, w, g, f) {
        if (o.definedFunction(u)) {
            ...
            let c = s.getCustomFormattedDateText(C, d, n, true);
