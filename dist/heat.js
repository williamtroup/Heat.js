...
(e => {
    ...
    function c(e) {
        ...
        for (let a = 0; a < e.totalColors; a++) {
            ...
            const C = Math.round(n.red / 100 * (u * i));
            const _ = Math.round(n.green / 100 * (u * i));
            const D = Math.round(n.blue / 100 * (u * i));
