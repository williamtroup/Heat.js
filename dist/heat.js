...
(function() {
  ...
  function V(a) {
    ...
    if (a.showDayNames) {
      var h = l("div", "days");
      c.appendChild(h);
      a.showMonthNames || (h.style.paddingTop = "0px", h.style.marginTop = "-5px");
      for (var f = 0; 7 > f; f++) {
    ...
    for (f = 0; 12 > f; f++) {
      if (-1 < a.monthsToShow.indexOf(f + 1)) {
        ...
        for (var A = 0; A < p; A++) {
          ...
          d && (-1 < a.daysToShow.indexOf(q) && aa(a, x, A - y, f, b, c), 0 === (A + 1) % 7 && (x = l("div", "day-column"), n.appendChild(x), q = 0));
          q++;
        }
  ...
  function aa(a, c, b, g, h, f) {
    var m = b + 1;
    b = l("div", "day");
    var n = new Date(h, g, m), p = k[a.element.id][J(n)];
  ...
  function da(a) {
    ...
    try {
      ...
      try {
        ...
        e.safeMode || (console.error("Errors in object: " + g.message + ", " + h.message), c = !1), b = null;
      }
    }
  ...
  var D = null, H = null, e = {}, v = {empty:"", space:" "}, M = {}, E = null, k = {};
  this.addDate = function(a, c, b) {
    k.hasOwnProperty(a) && (b = G(b) ? b : !0, c = J(c), k[a].hasOwnProperty(c) || (k[a][c] = 0), k[a][c]++, b && u(k[a].options));
    return this;
  };
  this.removeDate = function(a, c, b) {
    k.hasOwnProperty(a) && (c = J(c), k[a].hasOwnProperty(c) && (b = G(b) ? b : !0, k[a][c]--, b && u(k[a].options)));
    return this;
  };
  ...
  this.refresh = function(a) {
    k.hasOwnProperty(a) && (a = k[a].options, u(a), w(a.onRefresh, a.element));
    return this;
  };
  ...
  (function(a, c) {
    ...
    D.addEventListener("DOMContentLoaded", function() {
      for (var b = e.domElementTypes, g = b.length, h = 0; h < g; h++) {
        var f = D.getElementsByTagName(b[h]);
        f = [].slice.call(f);
          ...
          if (r(p) && p.hasAttribute("data-heat-options")) {
            ...
            if (C(d)) {
              if (d = da(d), d.parsed && F(d.result)) {
                ...
                d.showRefreshButton = z(d.showRefreshButton, !1);
                d.showMonthNames = z(d.showMonthNames, !0);
                ...
                var A = [{minimum:10, cssClassName:"day-color-1", tooltipText:"Day Color 1"}, {minimum:15, cssClassName:"day-color-2", tooltipText:"Day Color 2"}, {minimum:20, cssClassName:"day-color-3", tooltipText:"Day Color 3"}, {minimum:25, cssClassName:"day-color-4", tooltipText:"Day Color 4"}];
                q = L(q) ? q : A;
                y.mapRangeColors = q;
