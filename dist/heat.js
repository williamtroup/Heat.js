...
(() => {
    ...
    function we(t) {
        ...
        for (const e in n) {
            if (n.hasOwnProperty(e)) {
                i.push(Ve([ _e(e), _e(n[e].toString()) ]));
            }
        }
        if (i.length > 0) {
            i.unshift(Ve([ _e(e.text.dateText), _e(e.text.countText) ]));
        }
        return i.join("\n");
    }
    function ge(e) {
