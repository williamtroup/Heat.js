...
(() => {
    ...
    function de(t) {
        ...
        for (const e in n) {
            if (n.hasOwnProperty(e)) {
                i.push(ve([ De(e), De(n[e].toString()) ]));
            }
        }
        if (i.length > 0) {
            i.unshift(ve([ De(e.text.dateText), De(e.text.countText) ]));
        }
        return i.join("\n");
    }
    function fe(e) {
        return JSON.stringify(he(e));
    }
    function me(e) {
        const t = he(e);
        const n = [];
