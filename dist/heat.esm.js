...
(() => {
    ...
    function de(t) {
        ...
        for (const e in n) {
            if (n.hasOwnProperty(e)) {
                i.push(Te([ ve(e), ve(n[e].toString()) ]));
            }
        }
        if (i.length > 0) {
            i.unshift(Te([ ve(e.text.dateText), ve(e.text.countText) ]));
        }
        return i.join("\n");
    }
    function fe(e) {
