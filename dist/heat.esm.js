...
(() => {
    ...
    function fe(t) {
        ...
        for (const e in n) {
            if (n.hasOwnProperty(e)) {
                i.push(Se([ be(e), be(n[e].toString()) ]));
            }
        }
        if (i.length > 0) {
            i.unshift(Se([ be(e.text.dateText), be(e.text.countText) ]));
        }
        return i.join("\n");
    }
    function me(e) {
